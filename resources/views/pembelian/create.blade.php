    ...
    <div class="card card-custom mb-4">
        <div class="row g-4">
            <div class="col-md-3">
                ...
                <input type="text" name="no_faktur" class="form-control fw-bold text-primary" placeholder="INV-2026..." required>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="nama_supplier" class="form-control" placeholder="Ketik nama PT/CV..." required>
            </div>
            <div class="col-md-2">
                <label class="form-label">Metode</label>
                <select name="metode_pembayaran" class="form-select">
                    <option value="Cash">Cash</option>
                    <option value="Kredit">Tempo / Kredit</option>
                </select>
            </div>
        </div>
    </div>
                    ...
                    <tr>
                        <td>
                            <select name="item_obat[]" class="form-select" required>
                                ...
                                {{-- PERBAIKAN: Menggunakan $obat_array --}}
                        ...
                        <td class="text-center"><button type="button" class="btn btn-light text-danger" onclick="hapusBaris(this)" disabled><i class="fa-solid fa-trash"></i></button></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="row justify-content-end">
        <div class="col-md-5">
            <div class="bg-light rounded-4 p-4 text-end mb-3 border">
                ...
                <input type="hidden" name="total_faktur" id="inputTotalFaktur" value="0">
            </div>
...
@push('scripts')
<script>
    // PERBAIKAN: Menggunakan $obat_array di dalam script
